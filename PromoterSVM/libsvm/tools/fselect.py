...
if not is_win32:
	gridpy_exe = "./PromoterSVM/libsvm/tools/grid.py -log2c -2,9,2 -log2g 1,-11,-2"
	svmtrain_exe="./PromoterSVM/libsvm/windows/my-svm-train"
	svmpredict_exe="./PromoterSVM/libsvm/windows/svm-predict"
else:
	gridpy_exe = r".\PromoterSVM\libsvm\tools\grid.py -log2c -2,9,2 -log2g 1,-11,-2"
	svmtrain_exe=r".\PromoterSVM\libsvm\windows\my-svm-train.exe"
	svmpredict_exe=r".\PromoterSVM\libsvm\windows\svm-predict.exe"
